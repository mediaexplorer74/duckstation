...
#include "../dep/xbyak/xbyak.h"

#elif defined(CPU_AARCH32)

#include "../dep/vixl/aarch32/constants-aarch32.h"
#include "../dep/vixl/aarch32/instructions-aarch32.h"
#include "../dep/vixl/aarch32/macro-assembler-aarch32.h"

#elif defined(CPU_AARCH64)

#include "../dep/vixl/aarch64/constants-aarch64.h"
#include "../dep/vixl/aarch64/macro-assembler-aarch64.h"
